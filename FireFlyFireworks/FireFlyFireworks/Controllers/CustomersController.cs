...
namespace FireFlyFireworks.Controllers
{
    public class CustomersController : Controller
    {
        private readonly FireFlyFireworksContext _context;

        public CustomersController(FireFlyFireworksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstMidName,OrderDate")] Customer customer)
        {
