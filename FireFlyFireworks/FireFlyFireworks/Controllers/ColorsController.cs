...
namespace FireFlyFireworks.Views.Colors
{
    public class ColorsController : Controller
    {
        private readonly FireFlyFireworksContext _context;

        public ColorsController(FireFlyFireworksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ColorID,ColorName,Price,ColorFamID,ColorFamName")] Color color)
        {
