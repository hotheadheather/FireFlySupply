...
namespace FireFlyFireworks.Views
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(FireFlyFireworksContext context)
        {
            _context = context;
        }
        ...
        {
            var fireFlyFireworksContext = _context.Order.Include(o => o.Color).Include(o => o.Customer);
            return View(await fireFlyFireworksContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderID,ColorID,CustomerID")] Order order)
        {
